    ...
    module GameParserStates
      class InAuctionSection < GameParserState
        ...
        def process_char(char)
          ...
          # future enclosed BetweenCalls states will be notifying this class of note refs, which then
          # need to head up to GameParserState#expect_auction_ref_resolution
        end
