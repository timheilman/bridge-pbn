...
class PortableBridgeNotation::IoParser
    ...
    def each_game_string
      ...
      @io.each do |line|
        ...
        comment_is_open = PortableBridgeNotation::ParserUtil.instance.comment_open_after_eol? line, comment_is_open
      end
