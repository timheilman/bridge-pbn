# For now, place to catch conception of full portable bridge notation external API
...
#
# The Law of Demeter doesn't apply to this data structure, and no feature envy (methods of any kind) ought to be added
# to this structure; instead transform this structure into domain objects.
#
# Consider alternately (in a SAX vs DOM approach) adhering to the parsing event system in internals/game_parser.rb
